...
const TEMPLATE_CONFIGS: Record<Template, TemplateConfig> = {
	...
	collection007: { sidebarSide: "left", sidebarBackground: "solid", headerPosition: "main-only" },
	collection016: { sidebarSide: "left", sidebarBackground: "tint", headerPosition: "main-only" },
	collection017: { sidebarSide: "left", sidebarBackground: "tint", headerPosition: "main-only" },
	collection018: { sidebarSide: "left", sidebarBackground: "solid", headerPosition: "main-only" },
	collection019: { sidebarSide: "right", sidebarBackground: "tint", headerPosition: "main-only" },
	collection020: { sidebarSide: "left", sidebarBackground: "solid", headerPosition: "main-only" },
	collection021: { sidebarSide: "none", sidebarBackground: "none", headerPosition: "full-width" },
	collection022: { sidebarSide: "left", sidebarBackground: "tint", headerPosition: "main-only" },
	collection024: { sidebarSide: "left", sidebarBackground: "tint", headerPosition: "main-only" },
	collection026: { sidebarSide: "left", sidebarBackground: "solid", headerPosition: "main-only" },
	collection027: { sidebarSide: "none", sidebarBackground: "none", headerPosition: "full-width" },
	collection028: { sidebarSide: "left", sidebarBackground: "solid", headerPosition: "main-only" },
	collection029: { sidebarSide: "left", sidebarBackground: "tint", headerPosition: "main-only" },
