...
describe("getWebFontSource", () => {
	...
	it("uses bundled local fonts for PDF-critical families", () => {
		expect(getWebFontSource("IBM Plex Serif", "400")).toContain("ibm-plex-serif-400.ttf");
		expect(getWebFontSource("IBM Plex Serif", "700")).toContain("ibm-plex-serif-600.ttf");
		expect(getWebFontSource("Noto Sans SC", "400")).toContain("noto-sans-cjk-sc-regular.otf");
		expect(getWebFontSource("Noto Sans SC", "900")).toContain("noto-sans-cjk-sc-bold.otf");
		expect(getWebFontSource("Noto Serif SC", "400")).toContain("noto-serif-cjk-sc-regular.otf");
		expect(getWebFontSource("Noto Serif SC", "700")).toContain("noto-serif-cjk-sc-bold.otf");
	});
