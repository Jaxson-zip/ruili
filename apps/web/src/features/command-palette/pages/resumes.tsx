...
export function ResumesCommandGroup() {
	...
	return (
		<>
			<BaseCommandGroup heading={<Trans>搜索...</Trans>}>
				<CommandItem keywords={[t`我的简历`, t`Resumes`]} value="search.resumes" onSelect={() => pushPage("resumes")}>
					<ReadCvLogoIcon />
					<Trans>我的简历</Trans>
				</CommandItem>
			</BaseCommandGroup>

			<BaseCommandGroup page="resumes" heading={<Trans>我的简历</Trans>}>
