...
const renderCustomToast = () => {
	...
	return render(<I18nProvider i18n={i18n}>{customToast[0]("source-toast")}</I18nProvider>);
};
...
describe("DonationToast", () => {
	...
	it("waits before showing the source toast", () => {
	...
	it("sets a 30-day dismissed cookie and opens the Ruili repository when requested", () => {
		render(<DonationToast />);
		...
		fireEvent.click(screen.getByRole("button", { name: "查看锐历源码" }));
